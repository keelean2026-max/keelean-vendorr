...
const ProfessionalDocumentUpload = () => {
  ...
  const filteredDocuments = activeCategory === "all"
    ? [...Object.entries(documentConfig), ["bankDetails", {
      title: "Bank Details",
  ...
  const progressPercent = Math.round(((uploadedCount + (bankDetailsStatus === "completed" ? 1 : 0)) / totalCount) * 100);
  ...
  const handleSubmit = async (e) => {
    ...
    if (!canSubmit) {
      alert("Please upload all required documents and fill in all required information");
      return;
    }
    ...
    try {
      const submissionData = {
        ...
        bankDetails: {
          ...bankDetails,
          iban: (bankDetails.iban || "").replace(/[^A-Za-z0-9]/g, '').toUpperCase() // normalized IBAN
        },
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                  <div className="space-y-3">
                    <div className="text-xs text-gray-600 space-y-1.5">
                      ...
                      <p className="flex items-start gap-1"><span>•</span><span>Upload clear scans or photos</span></p>
                      <p className="flex items-start gap-1"><span>•</span><span>Ensure documents are not expired</span></p>
                      <p className="flex items-start gap-1"><span>•</span><span>File size limits apply</span></p>
                    </div>
                  </div>
                </div>
              </aside>
                          ...
                          <div className="flex items-start justify-between mb-3">
                            ...
                            <div className="flex items-center gap-2">
                              <span className={`rounded-full px-2 py-0.5 text-xs font-medium ${
                                bankDetailsStatus === "completed" ? "bg-green-50 text-green-700" :
                                "bg-gray-100 text-gray-600"
                              }`}>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    className={`w-full pl-10 pr-3 py-2.5 rounded-lg border ${
                                      errors.bankName ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                                    } text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1`}
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    type="text"
                                    className={`w-full pl-10 pr-3 py-2.5 rounded-lg border ${
                                      errors.accountHolderName ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                                    } text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1`}
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    type="text"
                                    className={`w-full pl-10 pr-3 py-2.5 rounded-lg border ${
                                      errors.accountNumber ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                                    } text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1`}
                              ...
                              <div>
                                ...
                                <div className="relative">
                                  ...
                                  <input
                                    type="text"
                                    className={`w-full pl-10 pr-3 py-2.5 rounded-lg border ${
                                      errors.iban ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-gray-300 focus:border-blue-500 focus:ring-blue-500'
                                    } text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-1`}
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="text-sm text-gray-600 flex items-center gap-2">
                      ...
                      {uploadedRequiredCount === requiredDocuments.length && bankDetailsStatus === "completed" ? (
                        <span className="text-green-600 font-medium">✓ All requirements met</span>
                      ) : (
                        <span className="text-gray-600 font-semibold">
                          {requiredDocuments.length - uploadedRequiredCount} document(s) and {bankDetailsStatus === "pending" ? "bank details" : ""} needed
                        </span>
                      )}
                    </div>
                    <button
